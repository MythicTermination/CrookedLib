package net.crookedman.example.client.renderer.entity.layer;
 ...
 * @see net.crookedman.example.client.renderer.entity.CoolKidRenderer
 */
public class CoolKidGlassesLayer extends GeoRenderLayer<CoolKidEntity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(CrookedLib.MOD_ID, "textures/entity/cool_kid_glasses.png");
