...
import net.crookedman.example.client.model.entity.MutantZombieModel;
...
import net.crookedman.crookedlib.renderer.layer.BlockAndItemGeoLayer;
import net.crookedman.crookedlib.renderer.layer.ItemArmorGeoLayer;
...
public class MutantZombieRenderer extends DynamicGeoEntityRenderer<DynamicExampleEntity> {
	...
	protected final ResourceLocation CAPE_TEXTURE = new ResourceLocation(CrookedLib.MOD_ID, "textures/entity/dynamic_entity_cape.png");
