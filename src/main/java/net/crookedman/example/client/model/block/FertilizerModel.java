...
package net.crookedman.example.client.model.block;
...
import net.crookedman.crookedlib.model.DefaultedBlockGeoModel;
...
public class FertilizerModel extends DefaultedBlockGeoModel<FertilizerBlockEntity> {
	private final ResourceLocation BOTARIUM_MODEL = buildFormattedModelPath(new ResourceLocation(CrookedLib.MOD_ID, "botarium"));
	private final ResourceLocation BOTARIUM_TEXTURE = buildFormattedTexturePath(new ResourceLocation(CrookedLib.MOD_ID, "botarium"));
	private final ResourceLocation BOTARIUM_ANIMATIONS = buildFormattedAnimationPath(new ResourceLocation(CrookedLib.MOD_ID, "botarium"));

	public FertilizerModel() {
		super(new ResourceLocation(CrookedLib.MOD_ID, "fertilizer"));
	}
