...
import net.crookedman.crookedlib.core.animation.RawAnimation;
 ...
 * Additionally, it encourages use of cached {@link net.crookedman.crookedlib.core.animation.RawAnimation RawAnimations}, to reduce overheads.
 */
public final class DefaultAnimations {
	 ...
	 * Recommended:
	 * <ul>
	 *     <li>{@link net.crookedman.crookedlib.animatable.GeoEntity GeoEntity}: state -> animatable</li>
	 *     <li>{@link net.crookedman.crookedlib.animatable.GeoBlockEntity GeoBlockEntity}: state -> animatable</li>
	 *     <li>{@link net.crookedman.crookedlib.animatable.GeoReplacedEntity GeoReplacedEntity}: state -> state.getData(DataTickets.ENTITY)</li>
	 *     <li>{@link net.crookedman.crookedlib.animatable.GeoItem GeoItem}: state -> state.getData(DataTickets.ITEMSTACK)</li>
