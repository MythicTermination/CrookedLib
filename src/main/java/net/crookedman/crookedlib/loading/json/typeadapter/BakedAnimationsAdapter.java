package net.crookedman.crookedlib.loading.json.typeadapter;
...
import net.crookedman.crookedlib.core.keyframe.BoneAnimation;
import net.crookedman.crookedlib.core.keyframe.Keyframe;
import net.crookedman.crookedlib.core.keyframe.KeyframeStack;
import net.crookedman.crookedlib.core.molang.MolangException;
import net.crookedman.crookedlib.core.molang.MolangParser;
import net.crookedman.crookedlib.core.molang.expressions.MolangValue;
...
/**
 * {@link Gson} {@link JsonDeserializer} for {@link net.crookedman.crookedlib.loading.object.BakedAnimations}.<br>
	...
	public BakedAnimations deserialize(JsonElement json, Type type, JsonDeserializationContext context) throws JsonParseException {
		...
		for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
			try {
				...
				CrookedLib.LOGGER.error("Unable to parse animation: " + entry.getKey());
				ex.printStackTrace();
			}
		}
