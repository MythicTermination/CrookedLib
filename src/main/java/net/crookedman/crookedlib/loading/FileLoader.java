package net.crookedman.crookedlib.loading;
...
public final class FileLoader {
	/**
	 * Load up and deserialize an animation json file to its respective {@link net.crookedman.crookedlib.core.animation.Animation} components
	...
	public static String getFileContents(ResourceLocation location, ResourceManager manager) {
		try (InputStream inputStream = manager.getResourceOrThrow(location).open()) {
			...
			CrookedLib.LOGGER.error("Couldn't load " + location, e);
