package net.crookedman.crookedlib.cache.texture;
...
import net.crookedman.crookedlib.resource.GeoGlowingTextureMeta;
...
public class AutoGlowingTexture extends GeoAbstractTexture {
	...
	protected RenderCall loadTexture(ResourceManager resourceManager, Minecraft mc) throws IOException {
		...
		try {
			...
			CrookedLib.LOGGER.warn("Resource failed to open for glowlayer meta: {}", this.glowLayer, e);
		}
