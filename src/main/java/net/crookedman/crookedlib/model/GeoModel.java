package net.crookedman.crookedlib.model;
...
import net.crookedman.crookedlib.CrookedLibException;
import net.crookedman.crookedlib.cache.GeckoLibCache;
import net.crookedman.crookedlib.cache.object.BakedGeoModel;
import net.crookedman.crookedlib.cache.object.GeoBone;
import net.crookedman.crookedlib.constant.DataTickets;
import net.crookedman.crookedlib.core.animatable.GeoAnimatable;
import net.crookedman.crookedlib.core.animatable.model.CoreGeoModel;
import net.crookedman.crookedlib.core.animation.Animation;
import net.crookedman.crookedlib.core.animation.AnimatableManager;
import net.crookedman.crookedlib.core.animation.AnimationState;
import net.crookedman.crookedlib.core.animation.AnimationProcessor;
import net.crookedman.crookedlib.core.molang.MolangParser;
import net.crookedman.crookedlib.core.molang.MolangQueries;
import net.crookedman.crookedlib.core.object.DataTicket;
import net.crookedman.crookedlib.loading.object.BakedAnimations;
import net.crookedman.crookedlib.renderer.GeoRenderer;
import net.crookedman.crookedlib.util.RenderUtils;
...
public abstract class GeoModel<T extends GeoAnimatable> implements CoreGeoModel<T> {
	...
	public BakedGeoModel getBakedModel(ResourceLocation location) {
		...
		if (model == null)
			throw new CrookedLibException(location, "Unable to find model");
	 ...
	 * @return An {@link Optional} containing the {@link net.crookedman.crookedlib.cache.object.GeoBone} if one matches, otherwise an empty Optional
	 */
	public Optional<net.crookedman.crookedlib.cache.object.GeoBone> getBone(String name) {
	...
	public Animation getAnimation(T animatable, String name) {
		...
		if (bakedAnimations == null)
			throw new CrookedLibException(location, "Unable to find animation.");
