...
import net.crookedman.crookedlib.loading.json.raw.*;
import net.crookedman.crookedlib.loading.json.typeadapter.BakedAnimationsAdapter;
import net.crookedman.crookedlib.loading.json.typeadapter.KeyFramesAdapter;
