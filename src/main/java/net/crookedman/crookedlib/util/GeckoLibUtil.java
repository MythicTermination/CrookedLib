package net.crookedman.crookedlib.util;
...
import net.crookedman.crookedlib.core.animation.EasingType;
import net.crookedman.crookedlib.core.animatable.instance.AnimatableInstanceCache;
import net.crookedman.crookedlib.core.animatable.instance.InstancedAnimatableInstanceCache;
import net.crookedman.crookedlib.core.animatable.instance.SingletonAnimatableInstanceCache;
...
public final class GeckoLibUtil {
	...
	/**
	 * Register a custom {@link net.crookedman.crookedlib.core.animation.Animation.LoopType} with GeckoLib,
	...
	/**
	 * Register a custom {@link net.crookedman.crookedlib.core.animation.EasingType} with GeckoLib,
	...
	/**
	 * Register a custom {@link net.crookedman.crookedlib.loading.object.BakedModelFactory} with GeckoLib,
	 ...
	 * NOTE: You do not need to register non-serializable {@link net.crookedman.crookedlib.core.object.DataTicket DataTickets}.
