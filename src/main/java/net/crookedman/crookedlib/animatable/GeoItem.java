...
import net.crookedman.crookedlib.cache.AnimatableIdCache;
import net.crookedman.crookedlib.util.RenderUtils;

/**
 * The {@link net.crookedman.crookedlib.core.animatable.GeoAnimatable GeoAnimatable} interface specific to {@link net.minecraft.world.item.Item Items}.
