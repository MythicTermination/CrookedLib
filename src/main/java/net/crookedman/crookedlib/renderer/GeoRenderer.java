...
import net.crookedman.crookedlib.cache.object.*;
...
import net.crookedman.crookedlib.core.object.Color;
...
public interface GeoRenderer<T extends GeoAnimatable> {
	 ...
	 *     <li>For {@link net.crookedman.crookedlib.animatable.GeoBlockEntity Tile Entities} and {@link net.crookedman.crookedlib.animatable.GeoItem Items}, it's currently unused</li>
	 * </ul>
