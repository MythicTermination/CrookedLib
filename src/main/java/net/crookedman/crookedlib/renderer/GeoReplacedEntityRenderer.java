package net.crookedman.crookedlib.renderer;
...
import net.crookedman.crookedlib.event.GeoRenderEvent;
...
/**
 * An alternate to {@link GeoEntityRenderer}, used specifically for replacing existing non-crookedlib
 * entities with crookedlib rendering dynamically, without the need for an additional entity class
 */
