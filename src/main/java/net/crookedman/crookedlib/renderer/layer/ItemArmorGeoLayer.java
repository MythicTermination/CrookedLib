package net.crookedman.crookedlib.renderer.layer;
 ...
 * Supports both {@link net.crookedman.crookedlib.animatable.GeoItem GeckoLib} and {@link net.minecraft.world.item.ArmorItem Vanilla} armor models.<br>
