...
package net.crookedman.crookedlib.core.animation;
...
import net.crookedman.crookedlib.core.animatable.model.CoreGeoBone;
import net.crookedman.crookedlib.core.animatable.model.CoreGeoModel;
import net.crookedman.crookedlib.core.keyframe.*;
import net.crookedman.crookedlib.core.keyframe.event.CustomInstructionKeyframeEvent;
import net.crookedman.crookedlib.core.keyframe.event.ParticleKeyframeEvent;
import net.crookedman.crookedlib.core.keyframe.event.SoundKeyframeEvent;
import net.crookedman.crookedlib.core.keyframe.event.data.CustomInstructionKeyframeData;
import net.crookedman.crookedlib.core.keyframe.event.data.KeyFrameData;
import net.crookedman.crookedlib.core.keyframe.event.data.ParticleKeyframeData;
import net.crookedman.crookedlib.core.keyframe.event.data.SoundKeyframeData;
import net.crookedman.crookedlib.core.molang.MolangParser;
import net.crookedman.crookedlib.core.molang.MolangQueries;
import net.crookedman.crookedlib.core.object.Axis;
import net.crookedman.crookedlib.core.object.PlayState;
import net.crookedman.crookedlib.core.state.BoneSnapshot;
