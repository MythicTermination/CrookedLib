package net.crookedman.crookedlib.resource;
...
/**
 * Metadata class that stores the data for GeckoLib's {@link net.crookedman.crookedlib.renderer.layer.AutoGlowingGeoLayer emissive texture feature} for a given texture
 */
