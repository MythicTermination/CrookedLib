...
public class CrookedLib {
	 ...
	 * Note that doing so will prevent {@link net.crookedman.crookedlib.renderer.GeoItemRenderer Items} from animating properly
	 */
